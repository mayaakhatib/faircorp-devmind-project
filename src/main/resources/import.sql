INSERT INTO BUILDING(id,name, outside_temperature) VALUES (-10, 'Building1', 22);
INSERT INTO BUILDING(id,name, outside_temperature) VALUES (-11,'Building2', 23);

INSERT INTO ROOM(id, name, floor, current_temperature, target_temperature, building_id) VALUES(-10, 'Room1', 1, 22.3, 20.0,-10);
INSERT INTO ROOM(id, name, floor,current_temperature, target_temperature, building_id) VALUES(-9, 'Room2', 1,0.0,0.0,-11);
--INSERT INTO ROOM(id, name, current_temperature, target_temperature,floor,building_id) VALUES(-8, 'Room3', 1,0.0,0.0,-11);
